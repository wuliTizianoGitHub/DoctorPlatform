...
var AppServiceTodoList = (function (_super) {
    ...
    function AppServiceTodoList(http) {
        ...
        _this.http = http;
        _this._getTodoListUrl = 'Home/GetTodoList';
        _this._getListAddUrl = 'Home/AddList';
        _this._getListUpdateUrl = 'Home/UpdateList';
        _this._getListDeleteUrl = 'Home/DeleteList';
        _this._getTaskAddUrl = 'Home/AddTask';
        _this._getTaskUpdateUrl = 'Home/UpdateTask';
        _this._getTaskDeleteUrl = 'Home/DeleteTask';
        _this.getaction(_this._getTodoListUrl).subscribe(function (result) {
